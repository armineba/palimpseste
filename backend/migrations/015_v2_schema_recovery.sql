-- Additive recovery slot: retain every original pass, artifact and provider attempt.
-- Supersedes the 014 constraints; deployments must not replay 013/014 afterwards.
BEGIN;
