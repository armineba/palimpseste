...
foreach ($name in @('D15_BEHAVIOR_AND_RESEARCH.md','UNITY_BEHAVIORS_D15.md','UNITY_ANIMATION_SHEET_D16.md','references-vfx-sources.md','NEXT_ACTIONS.md','TESTER_MAINTENANT.md')) {
