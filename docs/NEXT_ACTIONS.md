...
**Reprise réelle HTTP 202**, même job `5e763870284e41679c6b850b9b02ceff`, même dessin, description et recherche. Le schéma corrigé a été **accepté par le fournisseur** : réponse native `Success` avec sortie conservée. Le validateur a demandé une correction géométrique (`v2_core_aperture` : ouverture centrale non permise pour cette structure). Dernier état observé : **`planning`, tentative 8, correction de `structural_core` en cours**, sans erreur de transport. [Réponse réelle et correction en cours](../evidence/public/backend/schema-recovery-d21-3-provider-accepted.json). [Réponse de reprise](../evidence/public/backend/schema-recovery-d21-3-resume.json). Le sort n’est pas encore publié ; attendre son résultat et le verdict du créateur. Dans le Player déjà ouvert, cliquer **Actualiser**. Ne pas relancer A ni créer un dessin de démonstration.
