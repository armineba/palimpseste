...
**Actualisation D18 :** le plafond historique d'une demande décrit ci-dessous est supprimé à la demande du créateur. `PALIMPSESTE_MAX_PROVIDER_CONCURRENCY=0` autorise plusieurs jobs sans plafond applicatif. Les autres règles de compte et d'absence d'achat restent inchangées ; aucun quota fournisseur supplémentaire n'est créé.
...
## D18 — Plusieurs parchemins sans plafond applicatif (24 septembre 2026)
