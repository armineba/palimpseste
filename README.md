...
## D22.3 — construction et reprise corrigées

Conserve les propositions refusées et la critique, transmet les capacités géométriques exactes et corrige une incompatibilité artificielle `area/ribbon`. D22.1 restaure les mesures lors des reprises et fournit les huit représentations exécutables aux futures descriptions A. D22.3 surveille les erreurs des flux Codex et permet au propriétaire de reprendre un appel B expiré dont l’arrêt est confirmé. Backend publié ; installation et reprise du parchemin à suivre dans [l’état actuel](docs/NEXT_ACTIONS.md). Aucune réussite de rendu encore revendiquée.
